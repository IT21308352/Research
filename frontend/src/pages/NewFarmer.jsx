            ...
            <footer className="bg-green-800 text-white py-12 mt-16">
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap justify-between">
                        <div className="w-full md:w-1/3 mb-8 md:mb-0">
                            ...
                            <p className="text-green-200 mb-4">
                                A comprehensive resource for rice farmers to
                                implement best practices and achieve optimal
                                yields.
                            </p>
                        ...
                        <div className="w-full md:w-1/3">
                            ...
                            <p className="text-green-200 mb-2">
                                ...
                                support@paddyguide.com
                            </p>
                            <p className="text-green-200 mb-2">
                                <i className="fas fa-phone mr-2"></i> +1 (555)
                                123-4567
                            </p>
                            <p className="text-green-200">
                                <i className="fas fa-map-marker-alt mr-2"></i>{" "}
                                123 Farming Road, Rice Valley
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border-t border-green-700 mt-8 pt-8 text-center text-green-300">
                        <p>
                            © {new Date().getFullYear()} Paddy Cultivation
